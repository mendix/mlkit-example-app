...
public final class WordpieceTokenizer {
	 ...
	 * vocabulary. For example: input = "unaffable", output = ["un", "##aff",
	 * "##able"].
	 *
	 * @param text:
	 *            A single token or whitespace separated tokens. This should
	...
	public List<String> tokenize(String text) {
		...
		for (String token : BasicTokenizer.whitespaceTokenize(text)) {
			...
			boolean isBad = false; // Mark if a word cannot be tokenized into
									// known subwords.
			int start = 0;
